...
export default function App() {
  ...
  const updateCarouselIndex = (key: string, index: number) => {
    setCarouselIndices((prev) => (prev[key] === index ? prev : { ...prev, [key]: index }));
  };
