...
export default function App() {
  ...
  if (mainMenu) {
    const meetingCard = { target: 'reunion' as const, title: 'Reunión semanal', detail: 'Encontrémonos en vivo.', image: '/images/german-reunion.png' };
    const welcomeItems = mainCategories.map(([target, , title, detail]) => ({ target, title, detail, image: target === 'espacio' ? '/images/german-perfil.png' : target === 'biblioteca' ? '/images/german-biblioteca.png' : target === 'talleres' ? '/images/german-practicas.png' : target === 'propia' ? '/images/german-propia.png' : target === 'meditaciones' ? '/images/german-meditaciones.png' : target === 'consultas' ? '/images/german-consultas.png' : undefined }));
  ...
  // Estas 3 pantallas tienen fotos reales de fondo (a diferencia del resto
  // de las pantallas internas, que siguen con ícono chico + texto arriba):
