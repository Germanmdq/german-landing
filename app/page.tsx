...
const momentNodes: DeckItem[] = content.moments.map((moment, index) => ({
  ...
  image: index === 0 ? '/images/antes-reunion-entrevista-examen.png' : index === 1 ? '/images/cuando-te-agarro-la-ansiedad.png' : undefined,
  imageSize: (index === 0 || index === 1) ? ('compact' as const) : undefined,
