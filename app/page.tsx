...
const momentNodes: DeckItem[] = content.moments.map((moment, index) => ({
  ...
  image: index === 0 ? '/images/antes-reunion-entrevista-examen.webp' : index === 1 ? '/images/cuando-te-agarro-la-ansiedad.webp' : index === 2 ? '/images/cuando-no-podes-parar-la-cabeza-para-dormir.webp' : index === 3 ? '/images/cuando-te-peleaste-con-alguien.webp' : index === 4 ? '/images/cuando-te-llego-una-mala-noticia.webp' : index === 5 ? '/images/antes-de-tomar-una-decision-dificil.webp' : index === 6 ? '/images/cuando-te-sentis-solo.webp' : index === 7 ? '/images/cuando-estas-bajoneado-sin-saber-por-que.webp' : index === 8 ? '/images/antes-de-hablar-en-publico.webp' : index === 9 ? '/images/cuando-te-ataca-la-culpa.webp' : index === 10 ? '/images/para-arrancar-el-dia-con-fuerza.webp' : index === 11 ? '/images/para-cerrar-el-dia-en-paz.webp' : index === 12 ? '/images/cuando-tenes-miedo-de-algo.webp' : index === 13 ? '/images/cuando-queres-sentirte-mejor-rapido.webp' : '/images/cuando-necesitas-un-envion-de-seguridad.webp',
...
export default function App() {
  ...
  return <main className={`app-shell app-main section-app day-one-screen${photoCardsScreen ? ' photo-cards-screen' : ''}`}><section className="day-one-section"><FixedHeader eyebrow={screen.eyebrow} title={screen.title} subtitle={screen.subtitle} onBack={back} onNavigate={navigateTo} /><DayOneCarousel key={carouselKey} label={screen.title} items={screen.items.map((item) => item.accountPanel ? { ...item, image: '/images/mi-cuenta-acceso.webp' } : item.title === 'Favoritos' ? { ...item, image: '/images/favoritos-guardados.webp' } : item.title === 'Mi avance' ? { ...item, image: '/images/mi-avance-progreso.webp' } : item.title === 'Configuración' ? { ...item, image: '/images/configuracion-horarios-zona.webp' } : item.title === 'Activar notificaciones' ? { ...item, image: '/images/activar-notificaciones.webp' } : item.title === 'Horarios de práctica' ? { ...item, image: '/images/horarios-practica.webp' } : item.title === 'Preferencias' ? { ...item, image: '/images/preferencias-avisos.webp' } : item.title === 'Prácticas de 7 días' ? { ...item, image: '/images/interno-7dias.webp' } : item.title === 'Prácticas de 15 días' ? { ...item, image: '/images/interno-15dias.webp' } : item.title === 'Prácticas de 40 días' ? { ...item, image: '/images/interno-40dias.webp' } : item.title === 'Amor y relaciones' ? { ...item, image: '/images/interno-amor.webp' } : item.title === 'Dinero y trabajo' ? { ...item, image: '/images/interno-dinero.webp' } : item.title === 'Salud y bienestar' ? { ...item, image: '/images/interno-salud.webp' } : item.title === 'Antes de una reunion, entrevista o examen' ? { ...item, image: '/images/antes-reunion-entrevista-examen.webp' } : item.title === 'Cuando te agarro la ansiedad' ? { ...item, image: '/images/cuando-te-agarro-la-ansiedad.webp' } : item.title === 'Cuando no podes parar la cabeza para dormir' ? { ...item, image: '/images/cuando-no-podes-parar-la-cabeza-para-dormir.webp' } : item.title === 'Cuando te peleaste con alguien' ? { ...item, image: '/images/cuando-te-peleaste-con-alguien.webp' } : item.title === 'Cuando te llego una mala noticia' ? { ...item, image: '/images/cuando-te-llego-una-mala-noticia.webp' } : item.title === 'Antes de tomar una decision dificil' ? { ...item, image: '/images/antes-de-tomar-una-decision-dificil.webp' } : item.title === 'Cuando te sentis solo' ? { ...item, image: '/images/cuando-te-sentis-solo.webp' } : item.title === 'Cuando estas bajoneado sin saber por que' ? { ...item, image: '/images/cuando-estas-bajoneado-sin-saber-por-que.webp' } : item.title === 'Antes de hablar en publico' ? { ...item, image: '/images/antes-de-hablar-en-publico.webp' } : item.title === 'Cuando te ataca la culpa' ? { ...item, image: '/images/cuando-te-ataca-la-culpa.webp' } : item.title === 'Para arrancar el dia con fuerza' ? { ...item, image: '/images/para-arrancar-el-dia-con-fuerza.webp' } : item.title === 'Para cerrar el dia en paz' ? { ...item, image: '/images/para-cerrar-el-dia-en-paz.webp' } : item.title === 'Cuando tenes miedo de algo' ? { ...item, image: '/images/cuando-tenes-miedo-de-algo.webp' } : item.title === 'Cuando queres sentirte mejor rapido' ? { ...item, image: '/images/cuando-queres-sentirte-mejor-rapido.webp' } : item.title === 'Cuando necesitas un envion de seguridad' ? { ...item, image: '/images/cuando-necesitas-un-envion-de-seguridad.webp' } : item.title === 'Preguntar' ? { ...item, image: '/images/interno-preguntar.webp' } : item.title === 'Escuchar' ? { ...item, image: '/images/interno-escuchar.webp' } : item.title === 'Guardadas' ? { ...item, image: '/images/interno-guardadas.webp' } : item)} initialIndex={carouselIndicesRef.current[carouselKey] ?? 0} onIndexChange={(index) => { carouselIndicesRef.current[carouselKey] = index; }} onSelect={(item, index) => { carouselIndicesRef.current[carouselKey] = index; select(item); }} isFavorite={(item) => item.reader ? favorites.some((favorite) => favorite.id === deckFavorite(item).id) : undefined} onFavorite={(item) => toggleFavorite(deckFavorite(item))} /></section></main>;
}
