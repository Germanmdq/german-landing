...
- **Content is database-backed.** Editable workshop, meditation and library content lives in Supabase (`collections`, `content_items`, `collection_items`, `content_assets`). The app code should only render and orchestrate that content.
