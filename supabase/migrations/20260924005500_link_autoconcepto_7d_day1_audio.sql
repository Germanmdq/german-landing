...
insert into _autoconcepto_7d_audio (sort_order, storage_path, duration_seconds, file_size_bytes) values
  (1, 'practicas-guiadas/7-dias/autoconcepto/dia-01/meditaciones/6333.mp3', 111.020375, 1776376),
  (2, 'practicas-guiadas/7-dias/autoconcepto/dia-01/meditaciones/6334.mp3', 90.435875, 1447024),
  (3, 'practicas-guiadas/7-dias/autoconcepto/dia-01/meditaciones/6335.mp3', 90.435875, 1447024),
  (4, 'practicas-guiadas/7-dias/autoconcepto/dia-01/meditaciones/6336.mp3', 98.795063, 1580771);
...
where i.slug = 'practica-guiada-7-dias-dia-1'
...
join public.content_items i on i.slug = 'practica-guiada-7-dias-dia-1'
where not exists (
  select 1
